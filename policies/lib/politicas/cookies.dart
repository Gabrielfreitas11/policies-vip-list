...
class _CookiesState extends State<Cookies> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        child: Column(
      children: [
        temaNegrito(text: 'Cookies'),
        SizedBox(
          height: width * .02,
        ),
        titleNegrito(text: 'O que são cookies e qual a sua função?'),
        SizedBox(
          height: width * .02,
        ),
        Container(
        ...
        titleNegrito(text: 'Por que usamos cookies e tecnologias semelhantes?'),
        SizedBox(
          height: width * .02,
        ),
        Container(
        ...
        titleNegrito(text: "Probabilidade do controle de cookies"),
        SizedBox(
          height: width * .02,
        ),
        Container(
